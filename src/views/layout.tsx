...
export function Layout({ content, children }: LayoutProps) {
              ...
              <nav class='hidden items-center gap-8 md:flex' aria-label='Primary'>
                <button
                  ...
                  <span class='theme-light-icon'>
                    <Icon symbol='icon-sun' width={20} height={20} viewBox='0 0 24 24' />
                  </span>
                  <span class='theme-dark-icon'>
                    <Icon symbol='icon-moon' width={20} height={20} viewBox='0 0 24 24' />
                  </span>
                  <span class='theme-system-icon'>
                    <Icon symbol='icon-monitor' width={20} height={20} viewBox='0 0 24 24' />
                  </span>
                </button>
