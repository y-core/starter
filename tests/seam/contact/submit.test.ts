...
import { contactAction } from "../../../src/contact/controllers/submit";
import { ContactSchema } from "../../../src/contact/model/schema";
...
const BASE_TEST_CONFIG: AppConfig = configStore.get({ SITE_ORIGIN, ...CONFIG_ENV });
...
describe("POST /api/contact — email delivery failure", () => {
  ...
  // The provider echoes the recipient address back in its rejection body, which `src/email/services/email.ts`
